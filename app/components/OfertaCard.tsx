  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="text-2xl font-bold mb-2 text-shadow-md bg-black bg-opacity-50 p-2 rounded">
          {title}
        </h3>
      </div>
      <div className="p-6">
        ...
        <div className="bg-gray-700 bg-opacity-50 rounded-md p-3 mb-4 text-center">
          {mounted ? (
            ...
            <div className="flex justify-center space-x-2 text-lg">
              <span><span className="font-bold">--</span>h</span>
              <span><span className="font-bold">--</span>m</span>
              <span><span className="font-bold">--</span>s</span>
            </div>
          )}
        </div>
        <button
          ...
          disabled={mounted && timeLeft.days === 0 && timeLeft.hours === 0 && timeLeft.minutes === 0 && timeLeft.seconds === 0}
        >
          VER OFERTA
        </button>
      </div>
